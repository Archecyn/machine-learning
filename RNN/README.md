...
* Natural language processing: RNNs can be used to learn the relationships between words in a sentence, which can be used for tasks such as machine translation and text summarisation.
